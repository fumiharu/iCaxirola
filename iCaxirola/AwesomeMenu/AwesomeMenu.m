...
static CGFloat const kAwesomeMenuDefaultEndRadius = 90.0f; //最終的な位置
static CGFloat const kAwesomeMenuDefaultFarRadius = 140.0f;
static CGFloat const kAwesomeMenuDefaultStartPointX = 520.0; //startbtn 表示x
static CGFloat const kAwesomeMenuDefaultStartPointY = 270.0; //startbtn 表示x
static CGFloat const kAwesomeMenuDefaultTimeOffset = 0.036f; //ボタンの表示タイミング
static CGFloat const kAwesomeMenuDefaultRotateAngle = 0.0; //ボタンが飛び出る角度
static CGFloat const kAwesomeMenuDefaultMenuWholeAngle = M_PI_4 * -2;
static CGFloat const kAwesomeMenuDefaultExpandRotation = M_PI_4;
static CGFloat const kAwesomeMenuDefaultCloseRotation = M_PI_4 * -2;
